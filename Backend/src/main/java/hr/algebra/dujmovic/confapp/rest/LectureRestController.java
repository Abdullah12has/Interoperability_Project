...
public class LectureRestController {
    ...
    public LectureRestController(JmsTemplate jmsTemplate) {
    ...
    public Iterable<Lecture> findAll() {
        jmsTemplate.convertAndSend("The Lecture: " +repository.findAll().toString() + " are Fetched! \n");
    ...
    public ResponseEntity<Lecture> findOne(@PathVariable Long id) {
        ...
        if(lecture.isPresent()){
            jmsTemplate.convertAndSend("The Lecture: " + lecture.toString() + " is Fetched! \n");
    ...
    public ResponseEntity<Lecture> update(@PathVariable Long id, @RequestBody Lecture lecture) {
        if (repository.findById(id).isPresent()) {
            ...
            jmsTemplate.convertAndSend("The Lecture: " + lecture.toString() + " is Updated! \n");
    ...
    public void delete(@PathVariable Long id) {
        jmsTemplate.convertAndSend("The Lecture: " + id + " is Deleted! \n");

...
public class SpeakerRestController {
    ...
    public SpeakerRestController(JmsTemplate jmsTemplate) {
    ...
    public ResponseEntity<Speaker> findOne(@PathVariable Long id) {
        ...
        if(speaker.isPresent()){
            jmsTemplate.convertAndSend("The speaker: " + speaker.toString()+ " is Fetched! \n");
    ...
    public ResponseEntity<Speaker> update(@PathVariable Long id, @RequestBody Speaker speaker) {
        if (repository.findById(id).isPresent()) {
            ...
            jmsTemplate.convertAndSend("The speaker: " + speaker.toString() + " is Updated! \n");
    ...
    public void delete(@PathVariable Long id) {
        ...
        jmsTemplate.convertAndSend("The speaker: " + id + " is deleted! \n");
    }
}
